...
export const getHealth = () => fns.getHealth() as unknown as Promise<HealthResponse>;
export const getAgents = () => fns.getAgents() as unknown as Promise<AgentInfo[]>;
export const getProfile = () => fns.getProfile() as unknown as Promise<ProfileResponse>;
...
export const getDashboard = () => fns.getDashboard() as unknown as Promise<DashboardSnapshot>;
export const getJobs = (params: { limit?: number } = {}) =>
  fns.getJobs({ data: { limit: params.limit } }) as unknown as Promise<JobListing[]>;
export const getApplications = (params: { status?: string; limit?: number } = {}) =>
...
export const getActivity = (params: { limit?: number; task_id?: string } = {}) =>
...
export async function runJobSearch(input: SearchInput): Promise<SearchResponse> {
