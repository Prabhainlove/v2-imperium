...
const cols = [
  { n: "(1)", lead: "Uses native", rest: " scroll, refined by a precision smoothing formula." },
  { n: "(2)", lead: "Designed", rest: " with a lightweight, modular architecture that lets you import only what you need." },
  { n: "(3)", lead: "Configure", rest: " behavior directly in your markup with attribute-based controls — no extra JavaScript required, until you really need it." },
  { n: "(4)", lead: "Built for", rest: " core workflows, yet open to any prop or pattern your setup requires." },
];
      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col items-start justify-between gap-12 md:flex-row">
          ...
          <div className="max-w-xs pt-12 font-mono text-[11px] uppercase leading-relaxed tracking-[0.15em] text-black/70">
            Built to tune your agent,<br />not fight your stack.
          </div>
        </div>
