...
const primaryNav = [
  ...
  { title: "Profile", url: "/profile-preview", icon: UserCheck },
      ...
      <SidebarHeader className="border-b border-sidebar-border">
        <div className="flex items-center gap-2.5 px-2 py-2.5">
          ...
          <div className="flex flex-col leading-tight group-data-[collapsible=icon]:hidden">
            <span className="imp-h text-[14px] text-foreground">Imperium</span>
            <span className="text-[10px] uppercase tracking-[0.18em] text-muted-foreground">AI Job Agent</span>
          </div>
        </div>
      </SidebarHeader>
